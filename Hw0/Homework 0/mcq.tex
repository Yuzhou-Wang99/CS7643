...
%\item (1 point) Let $f(x, y) = x^2y + xy^2$. Calculate the directional derivative of $f$ at the point $(1, 1)$ in the direction of $\mathbf{v} = \langle 1, 2 \rangle$. Recall that the directional derivative is given by $\nabla f \cdot (\mathbf{v} / |\mathbf{v}|)$, where $\nabla f$ is the gradient and $|\mathbf{v}|$ is the magnitude of $\mathbf{v}$.
